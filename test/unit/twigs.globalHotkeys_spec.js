...
describe('Directive: twgHotkeys', function () {
  ...
  it('should trigger on simple hotkey', function (done) {
  ...
  it('should trigger on simple hotkey (code)', function (done) {
    var htmlElement = angular.element('<div twg-global-hotkeys></div>');
    var element = whenCompiling(htmlElement);
  ...
  it('should not trigger with wrong key', function (done) {
    var htmlElement = angular.element('<div twg-global-hotkeys><div class="some"></div></div>');
    var element = whenCompiling(htmlElement);
    var someElement = element.find('.some');
  ...
  it('should not trigger on input element', function (done) {
  ...
  it('should not trigger on textarea element', function (done) {
